...
set "TARGET_DIR=%~dp0Mini_setup_CREATE\4_RiverDischarge\hardcal"
...
echo Launching STEP 4 with Portable RStudio and Portable R 4.5.1...
start "" "%PORTABLE_RSTUDIO%" "%TARGET_DIR%\hardcal.Rproj"