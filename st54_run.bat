...
set "TARGET_DIR=%~dp0Mini_setup_CREATE\5_NBS\2_NBS_simulations"
...
echo Launching STEP 5.4 with Portable RStudio and Portable R 4.5.1...
start "" "%PORTABLE_RSTUDIO%" "%TARGET_DIR%\NBS_scenario_simulation.Rproj"