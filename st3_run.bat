...
set "TARGET_DIR=%~dp0Mini_setup_CREATE\3_CropYield\softcal"
...
echo Launching STEP 3 with Portable RStudio and Portable R 4.5.1...
start "" "%PORTABLE_RSTUDIO%" "%TARGET_DIR%\softcal.Rproj"