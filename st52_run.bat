...
set "TARGET_DIR=%~dp0Mini_setup_CREATE\5_NBS\1_Managment_scenario\2_Covcrop\FarmR_project"
...
echo Launching STEP 5.2 with Portable RStudio and Portable R 4.5.1...
start "" "%PORTABLE_RSTUDIO%" "%TARGET_DIR%\FarmR_project.Rproj"